    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="供应商名称" prop="gongyingshangmingcheng">
          <el-select v-model="ruleForm.gongyingshangmingcheng" placeholder="请选择供应商名称">
            <el-option
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../ssm6b9uv/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
