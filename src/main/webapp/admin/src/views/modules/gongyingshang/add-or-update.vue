    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="主要产品" prop="zhuyaochanpin">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhuyaochanpin" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuyaochanpin" label="主要产品" prop="zhuyaochanpin">
                    <span v-html="ruleForm.zhuyaochanpin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongsidizhi = true;
          ...
          if(o=='zhuyaochanpin'){
            this.ruleForm.zhuyaochanpin = obj[o];
	    this.ro.zhuyaochanpin = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.zhuyaochanpin = this.ruleForm.zhuyaochanpin.replace(reg,'../../../ssm6b9uv/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
